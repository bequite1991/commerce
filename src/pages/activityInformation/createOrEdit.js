...
class Index extends Component {
  ...
  eventClick(item){
    ...
    defaultStore.setActivitysEditor(param);
    setTimeout(()=>{
      t.goPage("/pages/activityInformation/editor");
    },500);
  }
  upload(t, path){
    wx.showToast({
    ...
      url: 'https://mokelay.com/config/commerce_oss_upload',
      ...
              //上传成功返回数据
        ...
        defaultStore.setActivitysEditor(param,false);
  ...
  render () {
    const {defaultStore,defaultStore:{activityDetail,activity_info_array}} = this.props;
    // const userPhoto = [{url:""}];
