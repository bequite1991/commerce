...
// import AtList from 'taro-ui/dist/weapp/components/list/index'
// import AtListItem from 'taro-ui/dist/weapp/components/list/item/index'
// import AtToast from 'taro-ui/dist/weapp/components/toast/index'
import { delayQuerySelector, uuid, initTestEnv, isTest } from './utils.js'
...
class AtIndexes extends AtComponent {
  ...
  render () {
    ...
    const customIndexesList = list.map(dataList => (
      <View
        id={`at-indexes__list-${dataList.key}`}
        className='at-indexes__list'
        key={dataList.key}
      >
        ...
        {dataList.items && dataList.items.map((item,index)=>{
